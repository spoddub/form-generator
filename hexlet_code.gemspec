...
Gem::Specification.new do |spec|
  ...
  spec.description = <<~DESC
    A small library for generating HTML forms in templates with a simple, declarative DSL.
    Inspired by Rails form helpers and Simple Form. Focused on predictable output and TDD-friendly design.
  DESC
